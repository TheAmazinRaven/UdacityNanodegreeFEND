...
4.28.22 Began working on For Loops, Increment and Decrement as well as Nested Loops. Worked on all Loop Quizes, got one of them right the first time I submitted my code :D. Started on Functions. Need tp practice calling functions + strings a number of times.